const data = [
    ...
    },
    {
      ...
      tags: "course offer program programme online offline self-paced duration length months weeks days",
      content:
    ...
    },
    {
      ...
      tags: "program content doing activities quizzes modules module learning assesments quizzes project projects",
      content:
    ...
    },
    {
      ...
      tags: "money-back guarantee job secure employment placement assistance",
      content:
        "They provide a money-back guarantee if graduates fail to secure a job. Accommodation assistance is also offered.",
    },
    {
      name: "Organizational Structure",
      tags: "team members staff deric yee ceo owner founder creator ken jin chen operations head daiben sanchez curriculum developer instructor",
      content:
